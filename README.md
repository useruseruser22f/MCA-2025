...
<!-- Version 1.0 -->
 Task 2 - Dataset Theme: Frédéric Chopin
...
Task 3 - Challenges of Working With Music Data & How They Apply to Chopin
General Challenges in Music Data
...
Multiple editions and editorial revisions: Chopin did not always leave definitive versions of his works, leading to disparities between early French, German, and English editions. This makes it challenging to choose which score should be the “authoritative” one for a dataset.
...
Audio: Recordings are distributed across streaming platforms (Spotify, YouTube, Naxos), and performers often release multiple interpretations of the same piece. Archival recordings from early pianists preserve historical performance styles.

Metadata: Musicological organisations and databases (MusicBrainz, The Chopin National Edition, library catalogues) curate metadata that includes opus numbers, catalog numbers, composition dates, keys, and editorial notes.

Chopin’s data landscape is rich but multi-layered, and the presence of many editions, interpretations, and cataloging systems makes curation both complex and rewarding.
